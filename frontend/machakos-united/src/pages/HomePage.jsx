// WRONG — lowercase 'react' causes the React.js duplicate crash on Windows
// import react from "react"

// CORRECT — in React 17+ you don't even need to import React for JSX
// But if you need hooks later, import them by name like this:
    ...
    return (
        <div className="bg-gray-50 font-sans">
            <header className="relative h-screen bg-cover bg-center bg-no-repeat"
                  style={{backgroundImage: "url('/images/hero-stadium.jpg')"}}>  {/* fixed missing closing quote */}
                <div className="absolute inset-0 bg-black/50">
                    <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-4">  {/* fixed 'relaive' typo */}
            ...
            <section className="py-20 px-4 max-w-6xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row items-center gap-12">
                    <div className="md:w-1/2">
                        <p>
                            Founded in 2005, Machakos United FC is more than a club - it's a family.
            ...
            <section className="bg-green-700 py-20 px-4 text-white">
                <div className="max-w-4xl mx-auto text-center">  {/* fixed 'mx-w-4xl' typo */}
                    <h2 className="text-3xl md:text-4xl font-bold mb-3">Latest Result</h2>
                    <p className="text-green-100 text-lg mb-8">KPL - Matchday 12 - Nyayo Stadium</p>
                    ...
                    <p className="mt-4">Goals: Ochieng' (12', 58'), Mwangi (90+3')</p>
                </div>
            </section>

            <section className="py-20 px-4 max-w-4xl mx-auto">
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden md:flex">
                    <div className="md:w-1/3 bg-green-600 text-white flex flex-col justify-center items-center p-8">
